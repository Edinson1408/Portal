...
class DocenteM extends PersonaM
{
    ...
    public function DatosDocentesM ($POST){
        ...
        $SQL="SELECT CONCAT(A.NOMBRES,' ',A.APELLIDOS) AS NOMBRES,A.EDAD,A.NUM_DOCUMENTO ,A.F_NACIMIENTO,B.IDDOCENTE,B.ANO_INGRESO,B.ANO_EGRESO,B.INSTITUCION_PROCEDENCIA,B.CARRERA_PROFESIONAL,B.ESTADO,C.DESCR250 AS CARRERA FROM `datos_personales_tbl` A 
